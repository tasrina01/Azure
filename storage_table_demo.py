...
resourcegroup_name = 'tas'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'tas'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
...
coffee.RowKey = '005'
coffee.brand = 'Lipton'
coffee.flavor = 'Black tea'
coffee.size = 'Tall'
coffee.cost = 3.49
table_service.insert_entity('itemstable', coffee)
print('Created entry for a Lipton Black...\n')
time.sleep(1)
...
coffee.flavor = 'Green tea'
coffee.size = 'Grande'
coffee.cost = 4.49
table_service.insert_entity('itemstable', coffee)
print('Created entry for Starbucks Green...\n')
time.sleep(1)
